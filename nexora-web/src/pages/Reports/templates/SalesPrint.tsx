      ...
      <table className="w-full text-sm border-collapse mb-8">
        ...
        <tbody>
          {data.length > 0 ? (
            ...
            <tr>
              <td colSpan={5} className="py-8 text-center text-slate-500 italic">No hay registros para las fechas seleccionadas</td>
            </tr>
          )}
        </tbody>
        {data.length > 0 && (
          <tfoot>
            <tr className="bg-slate-100 font-bold border-t-2 border-slate-800">
              <td colSpan={4} className="py-3 px-4 text-right uppercase tracking-wider">Total Generado</td>
